...
var setupFetchInstance = function (config) {
    ...
    var fetchWithInterceptors = function (input, init) { return __awaiter(void 0, void 0, void 0, function () {
        var requestConfig, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, originalFetch(input, requestConfig)];
                case 2:
                    response = _a.sent();
                    if (onResponse) {
